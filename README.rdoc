...
* v1.5.1: Support in-memory sorting for ActiveRecord sets; Set AridCache.order_in_memory.  Also
  add tentative support for sorting ActiveRecord collections using procs.
...
Ruby: 1.8.6, 1.8.7, REE 1.8.7 and 1.9.1, 1.9.2, 1.9.3
Rails: 2.3.8, 2.3.11, 3.0.0, Rails 3.0.5, 3.0.6 - 3.1.2
WillPaginate: 2.3.15 (Rails 2), 3.0.pre2 (Rails 3), 3.0
