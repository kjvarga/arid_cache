...
<b>Requires Ruby >= 1.8.7</b> due to changes to block argument handling that were made to 1.9 and back-ported to 1.8.7.

The version of Rails shouldn't matter much, but FYI I'm using 2.3.4.
